export default function LoadingTratamientoPage() {
  return (
    <section className="bg-stone-50 py-16 px-4">
      <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-2">
            <div className="h-5 w-20 rounded bg-stone-200 animate-pulse" />
          ...
          <div className="h-6 w-40 rounded bg-stone-200 animate-pulse" />
